...
<meta name="keywords" content="PickMeUp! Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
<div class="header">
	...
	<div class="banner text-center">
	  <div class="container">    
			<h1>Sell or Advertise   <span class="segment-heading">    anything online </span> with PickMeUp!</h1>
			...
			<div class="category-list">
				<div id="parentVerticalTab">
					...
					<div class="resp-tabs-container hor_1">
						<span class="active total" style="display:block;" data-toggle="modal" data-target="#myModal"><strong>Admin Dashboard</strong> </span>
						<div>
							<div class="category">
		...
		<footer>
			...
			<div class="container">
				...
				<div class="copyrights">
					<p> © 2016 PickMeUp!. All Rights Reserved | Design by  <a href="http://JustJava.com/"> JustJava</a></p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
