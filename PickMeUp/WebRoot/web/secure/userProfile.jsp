		...
		<div id="page-wrapper" class="sign-in-wrapper">
			<div class="graphs">
				<div class="sign-up">
					...
					<form action="/PickMeUp/servlet/UpdateProfileServlet" method="post">
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
								...
								<input type="text" placeholder="Enter your Name" required=" "
									name="name" value="${sessionScope.customer.name}" />
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
								...
								<input type="text" placeholder="Enter your Email" required=" " readonly="readonly"
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
								...
								<input type="text" placeholder="Enter your Contact Number"
									...
									value="${sessionScope.customer.contact}" />
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
								...
								<input type="text" placeholder="Enter your PinCode" required=" "
									name="pincode" value="${sessionScope.customer.pincode}" />
